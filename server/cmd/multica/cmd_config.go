...
var configSetCmd = &cobra.Command{
	...
	Long: "Supported keys: " +
		...
		"device_name, runtime_name, workspaces_root, native_workdir, codex_native_workdir, max_concurrent_tasks, poll_interval, " +
		...
		"platform_context_mode.\n\n" +
		"The daemon keys (device_name, runtime_name, workspaces_root, native_workdir, codex_native_workdir, max_concurrent_tasks, " +
...
func runConfigShow(cmd *cobra.Command, _ []string) error {
	...
	fmt.Fprintf(os.Stdout, "%-34s %s\n", "native_workdir:", valueOrDefault(cfg.NativeWorkDir, "(not set)"))
...
func applyConfigSet(cfg *cli.CLIConfig, key, value string) error {
	...
	case "native_workdir":
		...
		root, err := filepath.Abs(value)
		if err != nil {
			return fmt.Errorf("resolve native_workdir: %w", err)
		}
		cfg.NativeWorkDir = root
